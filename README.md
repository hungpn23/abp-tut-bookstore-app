...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e42d9ee7-9c0f-4388-9265-47d49d6433d7
```

> `e42d9ee7-9c0f-4388-9265-47d49d6433d7` is the password of the certificate, you can change it to any password you want.
